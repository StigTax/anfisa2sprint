# Generated by Django 3.2.16 on 2025-02-19 01:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='icecream',
            name='wrapper',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ice_cream', to='ice_cream.wrapper', verbose_name='Упаковка'),
        ),
        migrations.AlterField(
            model_name='topping',
            name='is_published',
